...
//            possible_moves.clear();
        ...
        for (int i = 0; i < this->current_coordinates.size(); ++i) {
            ...
            if ( this->current_coordinates[i] == pair(current_X,current_Y) )
            {
...
//    this->available_numbers.erase(this->symbol);
        this->current_coordinates.erase(
                remove(this->current_coordinates.begin(), this->current_coordinates.end(), pair(current_X,current_Y)),
